...
public class FuncionarioDAO {
    ...
    public void create(Funcionario funcionario) {
		...
		try (PreparedStatement query = conn.prepareStatement(sql)) {
			...
			System.out.println("FuncionarioDAO.create() -> "+ex.getMessage());
    ...
    public Funcionario read(int login) {
		...
		try (PreparedStatement query = conn.prepareStatement(sql)) {
			...
			System.out.println("FuncionarioDAO.read() -> "+ex.getMessage());
    ...
    public void update(Funcionario funcionario) {
		...
		try (PreparedStatement query = conn.prepareStatement(sql)) {
			...
			System.out.println("FuncionarioDAO.update() -> "+ex.getMessage());
	...
	public ArrayList<Funcionario> getAll() {
		...
		try (PreparedStatement query = conn.prepareStatement(sql)) {
			...
			System.out.println("FuncionarioDAO.getAll() -> "+ex.getMessage());
